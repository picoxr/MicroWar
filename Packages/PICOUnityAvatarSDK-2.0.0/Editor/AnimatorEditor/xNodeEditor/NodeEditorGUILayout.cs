...
namespace Pico.Avatar.XNodeEditor
{
    ...
    public static class NodeEditorGUILayout
    {
        ...
        public static void PropertyField(SerializedProperty property, GUIContent label, bool includeChildren = true, params GUILayoutOption[] options)
        {
            ...
            Pico.Avatar.XNode.Node node = property.serializedObject.targetObject as Pico.Avatar.XNode.Node;
            Pico.Avatar.XNode.NodePort port = node.GetPort(property.name);
            PropertyField(property, label, port, includeChildren);
        }

        /// <summary> Make a field for a serialized property. Manual node port override. </summary>
        public static void PropertyField(SerializedProperty property, Pico.Avatar.XNode.NodePort port, bool includeChildren = true, params GUILayoutOption[] options)
        {
            PropertyField(property, null, port, includeChildren, options);
        }

        /// <summary> Make a field for a serialized property. Manual node port override. </summary>
        public static void PropertyField(SerializedProperty property, GUIContent label, Pico.Avatar.XNode.NodePort port, bool includeChildren = true, params GUILayoutOption[] options)
        {
            if (property == null) throw new NullReferenceException();
            ...
            else
            {
                ...
                if (port.direction == Pico.Avatar.XNode.NodePort.IO.Input)
                {
                    ...
                    Pico.Avatar.XNode.Node.ShowBackingValue showBacking = Pico.Avatar.XNode.Node.ShowBackingValue.Unconnected;
                    Pico.Avatar.XNode.Node.InputAttribute inputAttribute;
                    ...
                    bool usePropertyAttributes = dynamicPortList ||
                        showBacking == Pico.Avatar.XNode.Node.ShowBackingValue.Never ||
                        (showBacking == Pico.Avatar.XNode.Node.ShowBackingValue.Unconnected && port.IsConnected);
                    ...
                    if (dynamicPortList)
                    {
                        ...
                        Pico.Avatar.XNode.Node.ConnectionType connectionType = inputAttribute != null ? inputAttribute.connectionType : Pico.Avatar.XNode.Node.ConnectionType.Multiple;
                        DynamicPortList(property.name, type, property.serializedObject, port.direction, connectionType);
                        return;
                    }
                    switch (showBacking)
                    {
                        case Pico.Avatar.XNode.Node.ShowBackingValue.Unconnected:
                            ...
                            break;
                        case Pico.Avatar.XNode.Node.ShowBackingValue.Never:
                            // Display a label
                            EditorGUILayout.LabelField(label != null ? label : new GUIContent(property.displayName, tooltip));
                            break;
                        case Pico.Avatar.XNode.Node.ShowBackingValue.Always:
                ...
                else if (port.direction == Pico.Avatar.XNode.NodePort.IO.Output)
                {
                    // Get data from [Output] attribute
                    Pico.Avatar.XNode.Node.ShowBackingValue showBacking = Pico.Avatar.XNode.Node.ShowBackingValue.Unconnected;
                    Pico.Avatar.XNode.Node.OutputAttribute outputAttribute;
                    bool dynamicPortList = false;
                    ...
                    {
                        Type type = GetType(property);
                        Pico.Avatar.XNode.Node.ConnectionType connectionType = outputAttribute != null ? outputAttribute.connectionType : Pico.Avatar.XNode.Node.ConnectionType.Multiple;
                        DynamicPortList(property.name, type, property.serializedObject, port.direction, connectionType);
                        return;
                    }
                    switch (showBacking)
        ...
        public static void PortField(Pico.Avatar.XNode.NodePort port, params GUILayoutOption[] options)
        {
            PortField(null, port, options);
        }

        /// <summary> Make a simple port field. </summary>
        public static void PortField(GUIContent label, Pico.Avatar.XNode.NodePort port, params GUILayoutOption[] options)
        {
            if (port == null) return;
        ...
        /// <summary> Make a simple port field. </summary>
        public static void PortField(Vector2 position, Pico.Avatar.XNode.NodePort port)
        {
            if (port == null) return;
        ...
        public static void AddPortField(Pico.Avatar.XNode.NodePort port)
        {
            if (port == null) return;
            Rect rect = new Rect();
        ...
        public static void PortPair(Pico.Avatar.XNode.NodePort input, Pico.Avatar.XNode.NodePort output)
        {
        ...
        public static bool IsInstancePortListPort(Pico.Avatar.XNode.NodePort port)
        {
            return IsDynamicPortListPort(port);
        }

        [Obsolete("Use DynamicPortList instead")]
        public static void InstancePortList(string fieldName, Type type, SerializedObject serializedObject, Pico.Avatar.XNode.NodePort.IO io, Pico.Avatar.XNode.Node.ConnectionType connectionType = Pico.Avatar.XNode.Node.ConnectionType.Multiple, Pico.Avatar.XNode.Node.TypeConstraint typeConstraint = Pico.Avatar.XNode.Node.TypeConstraint.None, Action<ReorderableList> onCreation = null)
        {
        ...
        public static bool IsDynamicPortListPort(Pico.Avatar.XNode.NodePort port)
        {
        ...
        {
            Pico.Avatar.XNode.Node node = serializedObject.targetObject as Pico.Avatar.XNode.Node;
            ...
            var indexedPorts = node.DynamicPorts.Select(x =>
            {
                ...
                return new { index = -1, port = (Pico.Avatar.XNode.NodePort)null };
            }).Where(x => x.port != null);
            List<Pico.Avatar.XNode.NodePort> dynamicPorts = indexedPorts.OrderBy(x => x.index).Select(x => x.port).ToList();
        ...
        private static ReorderableList CreateReorderableList(string fieldName, List<Pico.Avatar.XNode.NodePort> dynamicPorts, SerializedProperty arrayData, Type type, SerializedObject serializedObject, Pico.Avatar.XNode.NodePort.IO io, Pico.Avatar.XNode.Node.ConnectionType connectionType, Pico.Avatar.XNode.Node.TypeConstraint typeConstraint, Action<ReorderableList> onCreation)
        {
            ...
            list.drawElementCallback =
                ...
                {
                    Pico.Avatar.XNode.NodePort port = node.GetPort(fieldName + " " + index);
            ...
            list.onReorderCallback =
                (ReorderableList rl) =>
                {
                    ...
                    if (rl.index > reorderableListIndex)
                    {
                        ...
                        {
                            Pico.Avatar.XNode.NodePort port = node.GetPort(fieldName + " " + i);
                            Pico.Avatar.XNode.NodePort nextPort = node.GetPort(fieldName + " " + (i + 1));
            ...
            list.onAddCallback =
                (ReorderableList rl) =>
                {
                    if(Application.isPlaying && node is AvatarAnimationStateNode) 
                    {
                        EditorUtility.DisplayDialog("Warning","Cannot add or delete at runtime.", "OK");
                        return;
                    }
                    ...
                    if (io == Pico.Avatar.XNode.NodePort.IO.Output) node.AddDynamicOutput(type, connectionType, Pico.Avatar.XNode.Node.TypeConstraint.None, newName);
                ...
                (ReorderableList rl) =>
                {
                    ...
                    else
                    {
                        ...
                        for (int k = index + 1; k < dynamicPorts.Count(); k++)
                        {
                            ...
                            {
                                Pico.Avatar.XNode.NodePort other = dynamicPorts[k].GetConnection(j);
            ...
            if (hasArrayData)
            {
                ...
                while (dynamicPortCount < arrayData.arraySize)
                {
                    ...
                    if (io == Pico.Avatar.XNode.NodePort.IO.Output) node.AddDynamicOutput(type, connectionType, typeConstraint, newName);
                    else node.AddDynamicInput(type, connectionType, typeConstraint, newName);
                    EditorUtility.SetDirty(node);
                    dynamicPortCount++;
                }
