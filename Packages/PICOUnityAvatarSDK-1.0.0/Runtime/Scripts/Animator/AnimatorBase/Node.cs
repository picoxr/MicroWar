...
namespace Pico.Avatar.XNode
{
	...
	public abstract class Node : ScriptableObject
	{
		...
		public NodePort AddInstanceInput(Type type, Node.ConnectionType connectionType = Node.ConnectionType.Multiple,
		...
		public NodePort AddInstanceOutput(Type type, Node.ConnectionType connectionType = Node.ConnectionType.Multiple,
			Node.TypeConstraint typeConstraint = TypeConstraint.None, string fieldName = null)
		{
		...
		[SerializeField] public NodeGraph layer;
		...
		public virtual void InitStateNode(Pico.Avatar.AvatarAnimationLayer animationLayer)
		{
		}

		public virtual void InitTransition(AvatarAnimationLayer animationLayer)
		{
		}

		public virtual void UpdateStateNode()
		{
		}

		public virtual void UpdatePlayingState(AvatarAnimationState currentState)
		{
		}

		protected void OnEnable()
		{
			if (graphHotfix != null) layer = graphHotfix;
			graphHotfix = null;
			UpdatePorts();
			Init();
		}
