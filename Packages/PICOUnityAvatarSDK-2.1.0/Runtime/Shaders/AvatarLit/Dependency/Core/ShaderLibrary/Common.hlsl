...
#include "../../Core/ShaderLibrary/API/Vulkan.hlsl"
#elif defined(SHADER_API_SWITCH)
#include "../../Core/ShaderLibrary/API/Switch.hlsl"
#elif defined(SHADER_API_GLCORE)
#include "../../Core/ShaderLibrary/API/GLCore.hlsl"
#elif defined(SHADER_API_GLES3)
#include "../../Core/ShaderLibrary/API/GLES3.hlsl"
#elif defined(SHADER_API_GLES)
#include "../../Core/ShaderLibrary/API/GLES2.hlsl"
#else
#error unsupported shader api
#endif
#include "../../Core/ShaderLibrary/API/Validate.hlsl"

#include "../../Core/ShaderLibrary/Macros.hlsl"
#include "../../Core/ShaderLibrary/Random.hlsl"
...
#include "../../Core/ShaderLibrary/CommonDeprecated.hlsl"
