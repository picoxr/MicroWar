...
[Serializable, VolumeComponentMenuForRenderPipeline("Post-processing/Bloom", typeof(UniversalRenderPipeline))]
    ...
    public sealed partial class Bloom : VolumeComponent, IPostProcessComponent
    {
        ...
        public ClampedIntParameter maxIterations = new ClampedIntParameter(1, 1, 8);

        [Tooltip("The number of taps using for the Gaussian Blur"), AdditionalProperty]
        public GaussianTapParameter GaussianTaps = new GaussianTapParameter(BloomGaussianTaps._5Taps);
    ...
    [Serializable]
    public sealed class GaussianTapParameter : VolumeParameter<BloomGaussianTaps>
    {
        public GaussianTapParameter(BloomGaussianTaps value, bool overrideState = false) : base(value, overrideState) { }
    }
}
