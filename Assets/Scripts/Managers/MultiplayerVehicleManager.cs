...
{
    [Serializable]
    public class MultiplayerVehicleManager : VehicleManagerBase
    {
        ...
        public override void Setup(VehicleSettings vehicleSettings)
        {
            ...
            //Debug.Assert(vehicleSettings.VehicleType != VehicleType, $"VehicleType mismatch. Provided vehicleSettings is for {vehicleSettings.VehicleType}, expected settings for {VehicleType}");
