...
> [!IMPORTANT]
> Before you read further, please check out the **[PICO Body Tracking SDK Reference](https://developer-global.pico-interactive.com/document/unity/body-tracking/)**
> to see **how to enable body tracking** and learn more about the **requirements** and **concepts**.
